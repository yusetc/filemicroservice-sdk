...
```
{
  ...
  "require": {
    "yusetc/filemicroservice-sdk": ">=1.1.4"
  }
}
```
...
*SearchApi* | [**searchByKeyMetadata**](docs/Api/SearchApi.md#searchbykeymetadata) | **GET** /search/all/{key} | Search file by metadata key
