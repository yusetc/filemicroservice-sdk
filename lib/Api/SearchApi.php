...
class SearchApi
{
    ...
    /**
     * Operation searchMetadataKeyValueGet
*
...
*
    ...
    {
        list($response) = $this->searchMetadataKeyValueGetWithHttpInfo($key, $value);
        return $response;
    }

    /**
     * Operation searchMetadataKeyValueGetWithHttpInfo
*
...
case 0:$data = ObjectSerializer::deserialize(
    ...
    /**
     * Operation searchMetadataKeyValueGetAsync
     *
     * 
     *
* @param  string $key (required)
...
*
     ...
     */
    public function searchMetadataKeyValueGetAsync($key, $value)
    {
        return $this->searchMetadataKeyValueGetAsyncWithHttpInfo($key, $value)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation searchMetadataKeyValueGetAsyncWithHttpInfo
     *
     * 
     *
* @param  string $key (required)
...
$responseBody = $response->getBody();
    ...
    /**
     * Create request for operation 'searchMetadataKeyValueGet'
     *
* @param  string $key (required)
* @param  string $value (required)
*
     ...
     */
    protected function searchMetadataKeyValueGetRequest($key, $value)
    {
// verify the required parameter 'key' is set
        if ($key === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $key when calling searchMetadataKeyValueGet'
            );
        }
// verify the required parameter 'value' is set
        if ($value === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $value when calling searchMetadataKeyValueGet'
            );
        }
