...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://virtserver.swaggerhub.com/Giffits-Quito/fileservice-sdk/1.1.0';
    ...
    public function getHostSettings()
    {
        return array(
          array(
            "url" => "https://virtserver.swaggerhub.com/Giffits-Quito/fileservice-sdk/1.1.0",
            "description" => "SwaggerHub API Auto Mocking",
          ),
          array(
            "url" => "http://filservice.tools.giffits.de",
